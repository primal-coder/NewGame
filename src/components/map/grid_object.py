...
from src.components.map.grid import _AbstractGridObject, Grid as _Grid
...
class _BaseGridObject(_AbstractGridObject):
    def __init__(
        ...
        self.x = self.cell.coordinates[0] - 24 if self.cell is not None else None
        self.y = self.cell.coordinates[1] - 24 if self.cell is not None else None
