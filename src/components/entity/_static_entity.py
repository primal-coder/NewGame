...
class _StaticEntity(_BaseEntity):
    def __init__(self, name, cell, scale: _Optional[tuple[int, int]] = None, passable: _Optional[bool] = True, *args, **kwargs):
        super(_StaticEntity, self).__init__(name, cell, scale, *args, **kwargs)
