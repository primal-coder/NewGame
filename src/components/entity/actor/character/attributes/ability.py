...
from src.components.misc.die import ability_roll as _ability_roll, check
...
# Path: build/Ability.py

# build an Ability class which can be attached to a actor
...
class AbstractAbility:
    ...
    def is_primary(self, role: _Optional[str] = None):
        ...
        return role in ABILITIES[self.name]
