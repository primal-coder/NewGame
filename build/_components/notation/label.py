...
class _Label(_text.Label):
    def __init__(
        ...
        super(_Label, self).__init__(font_name="terminal", font_size=size, batch=self.batch_, color=(255, 255, 255, 255))
        self.x = x
        self.y = y
...
class _Message(_text.Label):
    def __init__(
        ...
        self.age = 0
        self.active = True
        super(_Message, self).__init__(text, "terminal", 10, True, False, False, (255, 255, 255, 255), x, y, batch=batch)
...
class _DynamicLabel(_Message):
    def __init__(
        ...
        super(_DynamicLabel, self).__init__(self.parent, x, y, self.string)
